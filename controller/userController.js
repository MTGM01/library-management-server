...
const register = (req, res) => {
  ...
  req.on("end", async () => {
    ...
    res.writeHead(registerResponse.statusCode, { "Content-Type": "application/json" })
...
const setCrime = (req, res) => {
  ...
  req.on("end", async () => {
    ...
    res.writeHead(userWithUpdatedCrime.statusCode, { "Content-Type": "application/json" })
...
const updateRole = (req, res) => {
  ...
  req.on("end", async () => {
    ...
    res.writeHead(newUserRole.statusCode, { "Content-Type": "application/json" })
